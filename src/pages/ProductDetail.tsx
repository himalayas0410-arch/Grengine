...
const STATIC_PRODUCTS: Record<string, any> = {
  'pistons': {
    ...
    richDescription: `
      <p class="mb-4">GEE AAR (GR) Pistons are gravity die-cast from eutectic silicon-aluminum alloy (LM13) and solution heat-treated to T6 condition for maximum tensile strength, low thermal expansion, and optimum hardness (85-110 HB).</p>
      ...
      <p class="mb-4">With 33 years of engineering expertise (Est. 1993), GEE AAR supplies pistons across 50-180mm bore sizes for light automotive, tractor, and heavy commercial diesel engines.</p>
    `,
  ...
  'air-compressor-kits': {
    ...
    richDescription: `
      <p class="mb-4">Heavy-duty air brake compressors produce the pressurized air essential for safe, responsive braking in trucks, buses and trailers. GEE AAR manufactures complete repair kits including cylinder block, pistons, and piston rings.</p>
      <p class="mb-4">A faulty or neglected compressor leads to low air pressure, brake lag and dangerous overheating. GEE AAR compressor repair kits deliver OEM-grade reliability and durability, keeping your fleet safe with regular maintenance and quality parts.</p>
    `,
  ...
  'piston-rings': {
    ...
    richDescription: `
      <p class="mb-4">GEE AAR Piston Rings are engineered from centrifugally cast ductile iron and micro-alloyed steel. Sliding faces undergo hard chromium plating, gas nitriding, and molybdenum spray coatings for minimal cylinder wall friction, zero scuffing, and exceptional wear resistance.</p>
  ...
  'valves': {
    ...
    richDescription: `
      <p class="mb-4">GEE AAR manufactures precision intake and exhaust valves from bi-metallic alloy steel for extreme operating temperatures and high wear resistance.</p>
  ...
  'valve-guides': {
    ...
    richDescription: `
      <p class="mb-4">GEE AAR Valve Guides are centrifugally cast from high-phosphorus grey iron or sintered bronze for superior thermal dissipation and stem lubrication.</p>
    `,
  ...
  'crankshafts': {
    ...
    richDescription: `
      <p class="mb-4">Precision dynamically balanced crankshafts manufactured by GEE AAR for high-torque heavy-duty engines.</p>
    `,
  ...
  'connecting-rods': {
    ...
    richDescription: `
      <p class="mb-4">GEE AAR connecting rods are drop-forged from micro-alloyed steel and precision bored for exact center-to-center dimensions.</p>
    `,
  ...
  'castings': {
    ...
    richDescription: `
      <p class="mb-4">Foundry solutions by GEE AAR producing custom agricultural and industrial component castings according to exact CAD drawings or physical samples.</p>
    `,
  ...
  'agricultural-diesel-engines': {
    ...
    richDescription: `
      <p class="mb-4">GEE AAR produces a complete range of heavy-duty replacement spare parts and engine assemblies for agricultural water pump engines, diesel generators, and agricultural tractors.</p>
  ...
  'power-gensets': {
    ...
    richDescription: `
      <p class="mb-4">GEE AAR supplies high-reliability stationary generator engine assemblies and spare parts for continuous prime power and agricultural water pump applications.</p>
  ...
  if (!product) {
    return (
      <div className="w-full pt-32 pb-24 min-h-screen bg-white flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-zinc-600 mb-8 max-w-md">Contact GEE AAR (GR Engine Parts) for custom OEM manufacturing or catalog specifications.</p>
