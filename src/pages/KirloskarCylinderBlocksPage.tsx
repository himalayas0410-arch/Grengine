...
export function KirloskarCylinderBlocksPage() {
  const specs = [
    { label: "Compatible Engines", value: "Kirloskar Air-Cooled Engines (AV1, TV1, DM Series)" },
  ...
  const features = [
    ...
    "Direct replacement fitment guaranteed for Kirloskar diesel engines and agricultural pumpsets.",
  ...
  return (
    <div className="w-full bg-white">
      <SEO 
        title="Air-Cooled Kirloskar Cylinder Blocks Manufacturer | GEE ARR (GR)"
        description="GEE ARR (GR) manufactures heavy-duty air-cooled Kirloskar cylinder blocks with deep cooling fins and centrifugally cast iron in Agra, India."
        canonicalPath="/products/kirloskar-cylinder-blocks"
      />
      ...
      <section className="bg-zinc-950 text-white py-16 md:py-20 relative overflow-hidden border-b border-orange-600/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="inline-block bg-[#EA580C] text-black text-xs font-black px-3.5 py-1 rounded-full uppercase tracking-wider mb-4">
            GEE ARR (GR) Core Offering
          </div>
          <h1 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-4">
            Kirloskar <span className="text-[#EA580C]">Cylinder Blocks (Air Cooled)</span>
          </h1>
          <p className="text-zinc-400 text-sm md:text-base max-w-2xl leading-relaxed">
            High-durability air-cooled cylinder block assemblies engineered with extended cooling fins for Kirloskar agricultural tractors, diesel pumps, and industrial generators.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-zinc-200 bg-zinc-100 p-4">
              <img 
                ...
                alt="Air-Cooled Kirloskar Cylinder Block by GEE ARR (GR)" 
            ...
            <div>
              ...
              <p className="text-zinc-600 text-sm md:text-base leading-relaxed mb-6">
                GEE ARR (GR) Air-Cooled Kirloskar Cylinder Blocks are cast from fine-grain alloy grey iron with precision-engineered cooling fins. The high thermal dissipation prevents cylinder distortion and bore scuffing under severe environmental conditions and long working hours.
              </p>
